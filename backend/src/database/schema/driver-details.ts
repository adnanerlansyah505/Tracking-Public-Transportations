...
export const driverDetails = pgTable('driver_details', {
  ...
  registrationDocument: varchar('registration_document', { length: 512 }),
  operationPermit: varchar('operation_permit', { length: 512 }),
  vehiclePhoto: varchar('vehicle_photo', { length: 512 }),
